...
import 'dart:math';
import 'package:vector_math/vector_math.dart' as vl;
...
class _BookingScreenState extends State<BookingScreen> {
  ...
  double calculateDistance(double lat1, double lon1, double lat2, double lon2) {
    ...
    double lat1Rad = vl.radians(lat1);
    double lon1Rad = vl.radians(lon1);
    double lat2Rad = vl.radians(lat2);
    double lon2Rad = vl.radians(lon2);
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => PayScreen(), // Replace 'PayScreen' with the actual class name.
            ),
          );
        },
        backgroundColor: Color(0xff8843b7), // Button background color
        child: Icon(Icons.payment), // Icon for the button
      ),
    );
  }
}
